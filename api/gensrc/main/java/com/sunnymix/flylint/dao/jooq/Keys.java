...
public class Keys {
    ...
    public static final UniqueKey<WikiRecord> KEY_WIKI_UK_PATH = Internal.createUniqueKey(Wiki.WIKI, DSL.name("KEY_wiki_uk_path"), new TableField[] { Wiki.WIKI.PATH }, true);
}
